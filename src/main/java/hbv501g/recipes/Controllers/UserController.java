...
public class UserController {
    ...
    /**
     * Logs the current user out by invalidating the session. Currently does nothing
     * in the backend, as the session is in the frontend
     * 
     * @param uid - id of user to be logged out
     */
    @Remove
